...
import ModalContent from '../components/GVC/Modal/content/ModalConfirmacao.vue'
import ButtonSecondaryNo from '../components/GVC/Buttons/ButtonSecondaryNo.vue'
import ButtonSecondary from '../components/GVC/Buttons/ButtonSecondary.vue'
import ButtonIcon from '../components/GVC/Buttons/ButtonIcon.vue'
import ButtonPrimaryNo from '../components/GVC/Buttons/ButtonPrimaryNo.vue'
const data = ref([
  {
    id: 1,
    name: 'Geovana',
...
const modalHidden = ref(Array(data.value.length).fill(true))
...
<template>
  <main>
    ...
    <div>
      <div class="content">
        <div class="more">
          <ButtonSecondary @click="toggleModal" text="Adicionar" />
        </div>
